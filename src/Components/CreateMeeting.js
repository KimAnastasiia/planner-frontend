...
import { Button, message, Flex, Input, Switch, Calendar, Tooltip, Form, List, Skeleton, TimePicker, Col, Radio, Row, Select, Typography, theme } from 'antd';
...
let CreateMeeting = () => {
    ...
    const [allowDublicateTimes, setAllowDublicateTimes] = useState(false)
        ...
        <Flex justify='center' style={{ width: "100%", minHeight: "100vh" }}>
            ...
            <Flex vertical justify='center' align='center' style={{ minHeight: "100vh", backgroundColor: "white", padding: 50 }}>
                ...
                <Form
                    ...
                    onFinish={CreateNewMeeting}

                    autoComplete="off"

                >
                    <Flex vertical justify='center' style={{ maxWidth: 260, }}>
                        <Form.Item
                            label="Title"
                            name="title"
                            rules={[
                        ...
                        <Flex justify="space-between">
                            <Typography.Title level={5} style={{ marginRight: 20 }}>Allow duplicate times</Typography.Title>
                            <Switch value={allowDublicateTimes} style={{ width: "30px" }} onChange={(checked) => { setAllowDublicateTimes(checked) }} />
                        </Flex>
                        <Flex justify="space-between">
